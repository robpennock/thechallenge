...
$(document).ready(function() {
    $('#ssdy-btn').click(function() {
        $('#mid-music').empty();
        $('#mid-music').append("<h1>Same Shit Different Year</h1>");
        $('#mid-music').append("<p>Thar be no lyrics here.</p>");
    });
    $('#air-btn').click(function() {
        $('#mid-music').empty();
        $('#mid-music').append("<h1>As I Remember</h1>");
        $('#mid-music').append("<p>As I sit and try, 
...
And do you remember? Do you remember 
 waking up to a world wholly new, or did you resist every change?</p>");
    });
    $('#mp-btn').click(function() {
        $('#mid-music').empty();
        $('#mid-music').append("<h1>Moments Passed</h1>");
        $('#mid-music').append("<p>Thar be no lyrics here.</p>");
    });
    $('#ny-btn').click(function() {
        $('#mid-music').empty();
        $('#mid-music').append("<p>ny</p>");
    });
    $('#va-btn').click(function() {
        $('#mid-music').empty();
        $('#mid-music').append("<p>test</p>");
    });
